...
func (d *DData) TFID() string {
	return fmt.Sprintf("data.%s.%s", placementgroup.DataSourceType, d.RName())
}
...
func (d *DDataList) TFID() string {
	return fmt.Sprintf("data.%s.%s", placementgroup.DataSourceListType, d.RName())
}
...
func (d *RData) TFID() string {
	return fmt.Sprintf("%s.%s", placementgroup.ResourceType, d.RName())
}
