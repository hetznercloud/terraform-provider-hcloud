...
func TestNetworkResourceSubnet(t *testing.T) {
	t.Run("basic", func(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy:             testsupport.CheckResourcesDestroyed(network.ResourceType, ByID(t, &nw)),
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(resNetwork.TFID(), ByID(t, &nw)),
	...
	t.Run("v-switch", func(t *testing.T) {
