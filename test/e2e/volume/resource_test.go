...
func TestVolumeResource(t *testing.T) {
	t.Run("basic", func(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy:             testsupport.CheckResourcesDestroyed(volume.ResourceType, ByID(t, &vol)),
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(res.TFID(), ByID(t, &vol)),
				...
				Steps: []resource.TestStep{
					{
						...
						Check: resource.ComposeTestCheckFunc(
							testsupport.CheckResourceExists(res.TFID(), ByID(t, &vol)),
							testsupport.CheckResourceExists(resAnotherVolume.TFID(), ByID(t, &vol2)),
							resource.TestCheckResourceAttr(res.TFID(), "name",
								fmt.Sprintf("volume-with-server--%d", tmplMan.RandInt)),
							resource.TestCheckResourceAttr(res.TFID(), "size", "10"),
							resource.TestCheckResourceAttr(res.TFID(), "location", resServer1.LocationName),
