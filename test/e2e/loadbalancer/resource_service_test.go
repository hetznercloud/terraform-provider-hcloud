...
import (
	...
	"github.com/hetznercloud/terraform-provider-hcloud/test/e2e/certificate"
)
...
func TestLoadBalancerService(t *testing.T) {
			...
			Steps: []resource.TestStep{
				{
					Config: tmplMan.Render(t,
						...
						"testdata/r/hcloud_load_balancer_service", &RDataService{
							Name:            svcName,
							Protocol:        "tcp",
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(lbResName, ByID(t, &lb)),
	...
	t.Run("https", func(t *testing.T) {
		...
		t.Run("update-unchanged-certificates", func(t *testing.T) {
	...
	t.Run("create-delete-no-listen-port", func(t *testing.T) {
	...
	t.Run("change-listen-port", func(t *testing.T) {
		var lb hcloud.LoadBalancer
