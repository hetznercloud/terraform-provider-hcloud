...
func init() {
	resource.AddTestSweepers(loadbalancer.ResourceType, &resource.Sweeper{
		Name: loadbalancer.ResourceType,
		Dependencies: []string{
...
func (d *DData) TFID() string {
	return fmt.Sprintf("data.%s.%s", loadbalancer.DataSourceType, d.RName())
}
...
func (d *DDataList) TFID() string {
	return fmt.Sprintf("data.%s.%s", loadbalancer.DataSourceListType, d.RName())
}
...
func (d *RData) TFID() string {
	return fmt.Sprintf("%s.%s", loadbalancer.ResourceType, d.Name)
}
...
// BasicRData is a resource for use in load balancer related test.
