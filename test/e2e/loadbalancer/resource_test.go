...
func TestLoadBalancerResource(t *testing.T) {
	t.Run("basic", func(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy:             testsupport.CheckResourcesDestroyed(loadbalancer.ResourceType, ByID(t, &lb)),
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(res.TFID(), ByID(t, &lb)),
	...
	t.Run("inline-target", func(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy: resource.ComposeAggregateTestCheckFunc(
				testsupport.CheckResourcesDestroyed(server.ResourceType, server2.ByID(t, nil)),
				testsupport.CheckResourcesDestroyed(loadbalancer.ResourceType, ByID(t, nil)),
			),
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						testsupport.CheckResourceExists(resServer1.TFID(), server2.ByID(t, &srv0)),
						testsupport.CheckResourceExists(resServer2.TFID(), server2.ByID(t, &srv1)),
