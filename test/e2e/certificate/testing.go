...
func init() {
	resource.AddTestSweepers(certificate.UploadedResourceType, &resource.Sweeper{
		Name:         certificate.UploadedResourceType,
		Dependencies: []string{},
		F:            Sweep,
	})
}
...
func (d *DData) TFID() string {
	return fmt.Sprintf("data.%s.%s", certificate.DataSourceType, d.RName())
}
...
func (d *DDataList) TFID() string {
	return fmt.Sprintf("data.%s.%s", certificate.DataSourceListType, d.RName())
}
...
func (d *RDataUploaded) TFID() string {
	return fmt.Sprintf("%s.%s", certificate.UploadedResourceType, d.RName())
}
...
func (d *RDataManaged) TFID() string {
	return fmt.Sprintf("%s.%s", certificate.ManagedResourceType, d.RName())
}
