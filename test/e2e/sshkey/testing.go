...
func init() {
	resource.AddTestSweepers(sshkey.ResourceType, &resource.Sweeper{
		Name:         sshkey.ResourceType,
		Dependencies: []string{},
		F:            Sweep,
	})
}
...
func (d *DData) TFID() string {
	return fmt.Sprintf("data.%s.%s", sshkey.DataSourceType, d.RName())
}
...
func (d *DDataList) TFID() string {
	return fmt.Sprintf("data.%s.%s", sshkey.DataSourceListType, d.RName())
}
...
func (d *RData) TFID() string {
	return fmt.Sprintf("%s.%s", sshkey.ResourceType, d.RName())
}
