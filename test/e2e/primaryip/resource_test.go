...
func TestPrimaryIPResource(t *testing.T) {
	t.Run("basic", func(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy:             testsupport.CheckResourcesDestroyed(primaryip.ResourceType, ByID(t, &pip)),
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(res.TFID(), ByID(t, &pip)),
	...
	t.Run("with-server", func(t *testing.T) {
		...
		testServerUpdatedRes := &server2.RData{
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy: resource.ComposeAggregateTestCheckFunc(
				testsupport.CheckResourcesDestroyed(server.ResourceType, server2.ByID(t, &srv)),
				testsupport.CheckResourcesDestroyed(primaryip.ResourceType, ByID(t, &primaryIPv4One)),
				testsupport.CheckResourcesDestroyed(primaryip.ResourceType, ByID(t, &primaryIPv4Two)),
				testsupport.CheckResourcesDestroyed(primaryip.ResourceType, ByID(t, &primaryIPv6One)),
			),
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(primaryIPv4OneRes.TFID(), ByID(t, &primaryIPv4One)),
						testsupport.CheckResourceExists(primaryIPv4TwoRes.TFID(), ByID(t, &primaryIPv4Two)),
						testsupport.CheckResourceExists(primaryIPv6OneRes.TFID(), ByID(t, &primaryIPv6One)),
						testsupport.CheckResourceExists(testServerRes.TFID(), server2.ByID(t, &srv)),
				...
				},
				{
					...
					Check: resource.ComposeTestCheckFunc(
						...
						testsupport.CheckResourceExists(primaryIPv4TwoRes.TFID(), ByID(t, &primaryIPv4Two)),
						testsupport.CheckResourceExists(primaryIPv6OneRes.TFID(), ByID(t, &primaryIPv6One)),
						testsupport.CheckResourceExists(testServerUpdatedRes.TFID(), server2.ByID(t, &srv)),
...
`,
	...
	t.Run("field-updates", func(t *testing.T) {
		var (
			...
			updateFields = func(d *RData, protection bool, autoDelete bool) *RData {
			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(protected.TFID(), ByID(t, &pip)),
				...
				},
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(unprotected.TFID(), ByID(t, &pip)),
