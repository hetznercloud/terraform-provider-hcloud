...
func TestPrimaryIPDataSource(t *testing.T) {
	t.Run("basic", func(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy:             testsupport.CheckResourcesDestroyed(primaryip.ResourceType, ByID(t, nil)),
	...
	t.Run("list", func(t *testing.T) {
		...
		primaryipBySel := &DDataList{
			LabelSelector: fmt.Sprintf("key=${%s.labels[\"key\"]}", res.TFID()),
		}
		primaryipBySel.SetRName("primaryip_by_sel")

		allPrimaryIPsSel := &DDataList{}
