...
func init() {
	resource.AddTestSweepers(primaryip.ResourceType, &resource.Sweeper{
		Name:         primaryip.ResourceType,
		Dependencies: []string{},
		F:            Sweep,
	})
}
...
func (d *DData) TFID() string {
	return fmt.Sprintf("data.%s.%s", primaryip.DataSourceType, d.RName())
}
...
func (d *DDataList) TFID() string {
	return fmt.Sprintf("data.%s.%s", primaryip.DataSourceListType, d.RName())
}
...
func (d *RData) TFID() string {
	return fmt.Sprintf("%s.%s", primaryip.ResourceType, d.RName())
}
