...
func init() {
	resource.AddTestSweepers(server.ResourceType, &resource.Sweeper{
		Name:         server.ResourceType,
		Dependencies: []string{},
		F:            Sweep,
	})
}
...
func (d *DData) TFID() string {
	return fmt.Sprintf("data.%s.%s", server.DataSourceType, d.RName())
}
...
func (d *DDataList) TFID() string {
	return fmt.Sprintf("data.%s.%s", server.DataSourceListType, d.RName())
}
...
func (d *RData) TFID() string {
	return fmt.Sprintf("%s.%s", server.ResourceType, d.RName())
}
