...
import (
	...
	"github.com/hetznercloud/terraform-provider-hcloud/test/e2e/floatingip"
...
func TestFloatingIPResourceAssignment(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				...
				},
				{
					...
					Check: resource.ComposeTestCheckFunc(
						testsupport.CheckResourceExists(resServer2.TFID(), server2.ByID(t, &s2)),
						testsupport.CheckResourceExists(resFloatingIP.TFID(), floatingip.ByID(t, &f)),
					),
				},
			},
