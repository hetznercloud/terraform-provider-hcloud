...
func init() {
	resource.AddTestSweepers(floatingip.ResourceType, &resource.Sweeper{
		Name:         floatingip.ResourceType,
		Dependencies: []string{},
		F:            Sweep,
	})
}
...
func (d *DData) TFID() string {
	return fmt.Sprintf("data.%s.%s", floatingip.DataSourceType, d.RName())
}
...
func (d *DDataList) TFID() string {
	return fmt.Sprintf("data.%s.%s", floatingip.DataSourceListType, d.RName())
}
...
func (d *RData) TFID() string {
	return fmt.Sprintf("%s.%s", floatingip.ResourceType, d.RName())
}
...
func (d *RDataAssignment) TFID() string {
	return fmt.Sprintf("%s.%s", floatingip.AssignmentResourceType, d.RName())
}
