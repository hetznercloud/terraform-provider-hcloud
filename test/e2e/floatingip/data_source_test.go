...
func TestFloatingIPDataSource(t *testing.T) {
	t.Run("basic", func(t *testing.T) {
		...
		resource.ParallelTest(t, resource.TestCase{
			...
			CheckDestroy:             testsupport.CheckResourcesDestroyed(floatingip.ResourceType, ByID(t, nil)),
	...
	t.Run("list", func(t *testing.T) {
		...
		floatingipBySel := &DDataList{
			LabelSelector: fmt.Sprintf("key=${%s.labels[\"key\"]}", res.TFID()),
		}
		floatingipBySel.SetRName("floatingips_by_sel")

		allFloatingIPsSel := &DDataList{}
