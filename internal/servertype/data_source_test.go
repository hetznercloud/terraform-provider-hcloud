		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_type_ids.1", "22"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "names.0", "cx11"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "names.1", "cpx11"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "descriptions.0", "CX11"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "descriptions.1", "CPX 11"),

					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.id", "22"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.name", "cpx11"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.cores", "2"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.memory", "2"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.disk", "40"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.storage_type", "local"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.cpu_type", "shared"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.architecture", "x86"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.included_traffic", "0"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.is_deprecated", "false"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.deprecation_announced", ""),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.1.unavailable_after", ""),
				),
			},
		},
	})
