		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.id", "22"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.name", "cpx11"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.cores", "2"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.memory", "2"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.disk", "40"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.storage_type", "local"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.cpu_type", "shared"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.architecture", "x86"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.included_traffic", "0"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.is_deprecated", "false"),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.deprecation_announced", ""),
					resource.TestCheckResourceAttr(servertypesD.TFID(), "server_types.5.unavailable_after", ""),
				),
			},
		},
	})
